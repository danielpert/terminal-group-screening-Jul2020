...
class SilicaInterfaceCarve(mb.Compound):
    ...
    Note: This is identical to the class available in mBuild, except here
          the routine is tweaked to make sure surface sites are not
          identified too deep in the silica surface, which has been found
          to yield unfavorable and unrealistic headgroup behavior.
    ...
    def __init__(self, bulk_silica, tile_x=1, tile_y=1, thickness=1.0, seed=12345):
        super(SilicaInterfaceCarve, self).__init__()
